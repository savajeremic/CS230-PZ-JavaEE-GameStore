...
import com.projekat.sessionBean.GameFacade;
...
public class GameController implements Serializable {
    ...
    @EJB
    private com.projekat.sessionBean.GameFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        System.out.println("AADDADA " + JsfUtil.getSelectItems(ejbFacade.findAll(), true));
    ...
    public static class GameControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Game) {
                Game o = (Game) object;
                return getStringKey(o.getGameId());
            } else {
